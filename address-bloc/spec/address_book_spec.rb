     ...
     describe "#add_entry" do
      ...
      describe "#import_from_another_csv" do
        ...
        it "imports the 1st entry" do
          book.import_from_csv("entries_2.csv")
          entry_one = book.entries[0]
          check_entry(entry_one, "Joy","239-390-8320","Joy@blocmail.com")
        end

        it "imports the 2nd entry" do
           book.import_from_csv("entries_2.csv")
           entry_two = book.entries[1]
           check_entry(entry_two, "Kris","223-932-4852","Kris@blocmail.com")
         end

         it "imports the 3rd entry" do
           book.import_from_csv("entries_2.csv")
           entry_three = book.entries[2]
           check_entry(entry_three, "Lily","320-239-4802","Lily@blocmail.com")
         end
       end
